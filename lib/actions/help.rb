...
class HelpM
  ...
  alias group groups
  alias new_group groups
  alias rm_group groups
  ...
  alias new_assignment assignments
  ...
  alias new_issue issues
  alias issue issues
  alias open_issue issues
  alias close_issue issues
  ...
  alias new_relation new_people_info
  alias rm_people_info new_people_info
