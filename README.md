...
vez.[]{label="fig:masterv1"}](images/login-example.png)
...
bash.[]{label="fig:bash-example"}](images/bash-example.png)
...
usuario.[]{label="fig:clone-example"}](images/clone-example.png)

![Ejemplo de clonar un repositorio de
organización.[]{label="fig:clone-example-org"}](images/clone-example-org.png)
...
usuario.[]{label="fig:user-commits"}](images/user-commits.png)

![Mostrar commits de la rama de un repositorio de
organización.[]{label="fig:user-commits"}](images/orgs-commits.png)
...
repositorio.[]{label="fig:dir-content"}](images/dir-content.png)

![Listar contenido de un
subdirectorio.[]{label="fig:subdir-content"}](images/subdir-content.png)
...
![Añadir miembros
específicos.[]{label="fig:invite-member"}](images/invite-member.png)
...
fichero.[]{label="fig:add-members-fil"}](images/add-members-file.png)
...
fichero.[]{label="fig:invite-collabs"}](images/invite-collabs.png)
...
repositorio.[]{label="fig:list-issues"}](images/list-issues.png)

![Listado de incidencias del repositorio en
GitHub.[]{label="fig:issues-list"}](images/issues-list.png)
...
organización.[]{label="fig:new-issue"}](images/new-issue.png)

![Formulario de creación de incidencias
(issues).[]{label="fig:new-issue"}](images/issue-form.png)
...
repositorio.[]{label="fig:create-repo"}](images/create-repo.png)

![Creación de un repositorio de usuario con opciones
específicas.[]{label="fig:custom-repo"}](images/custom-repo.png)
...
GitHub.[]{label="fig:create-team-form"}](images/create-team-form.png)

![Creación de un equipo mediante
fichero.[]{label="fig:create-team-file"}](images/create-team-file.png)
...
ghedsh.[]{label="fig:show-orgs-regexp"}](images/show-all-orgs.png)

![Filtrar organizaciones mediante expresión
regular.[]{label="fig:show-orgs-regexp"}](images/show-orgs-regexp.png)
...
organización.[]{label="fig:org-people"}](images/org-people.png)

![Mostrar mediante expresión regular los miembros de una
organización.[]{label="fig:org-people-regexp"}](images/org-people-regexp.png)
...
-   Contexto **organización**: muestra los repositorios de la
    ...
    usuario.[]{label="fig:user-repos"}](images/user-repos.png)

-   Contexto **usuario**: muestra los repositorios del usuario
    autenticado en *ghedsh*.

    ![Comando repos a nivel de
    organización.[]{label="fig:org-repos"}](images/org-repos.png)
...
![Eliminación de un
repositorio.[]{label="fig:custom-repo"}](images/delete-repo.png)
...
organización.[]{label="fig:org-teams"}](images/org-teams.png)

![Listar mediante expresión regular los equipos de una
organización.[]{label="fig:org-regexp-teams"}](images/org-regexp-teams.png)
...
evaluación.[]{label="fig:eval-example"}](images/eval-example.png)

![Estructura de un repositorio de evaluación en
GitHub.[]{label="fig:eval-example"}](images/eval-preview.png)
...
![Ejemplo de ghedsh
foreach.[]{label="fig:foreach-example"}](images/foreach-example.png)
